          ...
          <div className={`relative w-full h-full transition-all duration-500 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
            ...
            {!isFlipped && (
              <div className="absolute inset-0 bg-white rounded-3xl shadow-xl border-2 border-gray-100 flex flex-col items-center justify-center p-10 text-center hover:border-brand-200 transition-colors overflow-y-auto">
                 ...
                 <h4 className="text-red-400 text-sm font-bold uppercase tracking-widest mb-3">You Wrote</h4>
                 ...
                 <div className="bg-yellow-50 px-4 py-2 rounded-lg border border-yellow-100 mt-auto">
                   <p className="text-sm text-yellow-800 flex items-center gap-2">
                     <Lightbulb size={14} className="text-yellow-600" />
                     Hint: {currentCard.reason.slice(0, 60)}...
                   </p>
                 </div>
                 <p className="mt-4 text-gray-300 text-xs font-medium">Click to flip</p>
              </div>
            )}
            ...
            {isFlipped && (
              <div className="absolute inset-0 bg-brand-600 rounded-3xl shadow-xl flex flex-col items-center justify-center p-10 text-center text-white overflow-y-auto">
                 ...
                 <h4 className="text-brand-200 text-sm font-bold uppercase tracking-widest mb-4">Better Alternative</h4>
                 <p className="text-3xl font-serif font-medium leading-snug">
                   {currentCard.better}
                 </p>
                 {currentCard.context && (
                    <div className="mt-6 p-4 bg-brand-700/30 rounded-xl border border-brand-500/30">
                        <p className="text-brand-100 text-xs font-bold uppercase tracking-widest mb-1">Original Context</p>
                        <p className="text-white font-serif text-lg italic leading-relaxed opacity-90">
                            "{currentCard.context}"
                        </p>
                    </div>
                 )}
